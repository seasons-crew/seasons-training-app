...
export function MediaAddTabs({ bulk, manual }: MediaAddTabsProps) {
  ...
  return (
    <section className="min-w-0 overflow-hidden rounded-md bg-white p-4 shadow-[0_0_0_1px_rgba(0,0,0,0.08),0_8px_24px_rgba(0,0,0,0.04)]">
      <div className="grid min-w-0 grid-cols-2 rounded-md bg-stone-100 p-1">
        <button
          type="button"
      ...
      <div className="mt-4 min-w-0">{activeTab === "bulk" ? bulk : manual}</div>
    </section>
  );
}
